module Norm
  module TestCaseTranslator
    ...
    def self.end_cleanup_section(code)
      code << "  end\n"
    end

    def self.end_steps(code)
      code << "  ensure\n  end\n"
      code
    end

    def self.end_test_case(code)
      code << "end\n"
      code
    end

    def self.end_test_case_header(code)
      code.strip!
